...
export default function ThreePiecePageWrapper() {
  return (
    <React.Suspense
      fallback={
...
function ThreePiecePage() {
  ...
  function updateParams(updates: Record<string, string | undefined>) {
    ...
    router.push(`/three-piece?${params.toString()}`, { scroll: false })
  }

  // Handle add to cart
  function handleAddToCart(product: Product, e: React.MouseEvent) {
    const imageUrl =
      product.images?.[0] || "/images/products/boutique-1.png"
  ...
  return (
    <div className="flex min-h-screen flex-col bg-background">
      ...
      <section className="relative h-[400px] w-full overflow-hidden">
        <Image
          src="/images/categories/boutique.png"
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center text-white p-4">
          ...
          <p className="max-w-xl text-lg opacity-90 md:text-xl">
            Elevate your wardrobe with our curated three-piece collections.
            Premium fabrics, timeless designs, handcrafted with care.
          </p>
        </div>
      </section>
            ...
            <div className="sticky top-24 space-y-8">
              ...
              {(selectedFabrics.length > 0 ||
                ...
                <Button
                  ...
                  onClick={() => router.push("/three-piece")}
                >
            ...
            {allProducts.length > 0 && (
              <div className="grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 xl:grid-cols-3">
                {allProducts.map((product) => {
                  const imageUrl =
                    product.images?.[0] ||
                    "/images/products/boutique-1.png"
