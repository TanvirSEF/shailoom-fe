              ...
              <div className="flex flex-col gap-6 py-6">
                ...
                <div className="mt-4 flex flex-col gap-3 border-t pt-4">
                  {isUserLoggedIn ? (
                    isAdmin ? (
                      <>
                        <Link href="/admin" className="flex items-center gap-2 text-lg font-medium hover:text-primary transition-colors py-2">
                      ...
                      >
                        <div className="mb-2 px-3 py-3 border-b border-border">
                          <div className="flex items-center gap-3">
                            ...
                            <div className="flex flex-col min-w-0">
                              <p className="text-sm font-bold leading-none mb-1">Admin Panel</p>
                              <p className="text-xs text-muted-foreground leading-none">shailoom.com</p>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="flex flex-col space-y-1">
                          <Link href="/admin" onClick={() => setIsDropdownOpen(false)}>
                            <div className="flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium transition-colors hover:bg-primary/10 hover:text-primary text-muted-foreground cursor-pointer">
                              <LayoutDashboard className="h-4 w-4" /> Dashboard
                            </div>
                          </Link>
                          <div className="my-1 border-t border-border" />
                          <button onClick={handleLogout} className="flex w-full items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium transition-colors hover:bg-destructive/10 text-destructive cursor-pointer">
